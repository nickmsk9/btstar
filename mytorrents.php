...
<?
	...
	$res = sql_query("SELECT torrents.type, torrents.comments, torrents.leechers, torrents.seeders, torrents.id, torrents.multitracker, torrents.f_seeders, torrents.f_peers, categories.name AS cat_name, categories.image AS cat_pic, torrents.name, save_as, filename, numfiles, added, size, views, visible, free, hits, times_completed, category FROM torrents LEFT JOIN categories ON torrents.category = categories.id $where ORDER BY id DESC $limit");
