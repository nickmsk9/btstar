...
<h4>Основная информация <? if ($user['id']==$CURUSER['id']) { ?><a href="my.php?t=profile" style="color: gray;">[Редактировать]</a> <?} ?></h4>
...
<? } ?>
<h4>Контактная информация <? if ($user['id']==$CURUSER['id']) { ?><a href="my.php?t=contact" style="color: gray;">[Редактировать]</a> <?} ?></h4>
...
<? if ($user["icq"]){?>
<div align="left"><b><font color="gray">Номер ICQ:</font></b> <img src="email_img.php?uid=<?=$user['id'];?>&type=2" alt="ICQ пользователя <?=$user['name'];?>"></div><? } ?>
<? if ($user['website']) { ?>
<div align="left"><b><font color="gray">Сайт:</font></b> <a href="goto.php?link=<?=urlencode(urlencode($user['website']));?>"><?=$user['website'];?></a></div><? } ?><br>
...
<h4>Личная информация <? if ($user['id']==$CURUSER['id']) { ?><a href="my.php?t=about" style="color: gray;">[Редактировать]</a> <?} ?></h4>
<?
