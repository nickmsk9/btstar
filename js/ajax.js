...
function signup_check(action) {
	 ...
	 if (action == "icq")
	 ajax.setVar("icq", document.getElementById('icq').value);
	 if (action == "name")
	 ajax.setVar("name", document.getElementById('name').value);
	 if (action == "surname")
	 ajax.setVar("surname", document.getElementById('surname').value);
