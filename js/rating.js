...
if (document.images){
  ...
  pic1.src = "pic/loading.gif";

  pic2 = new Image(25,75);
  pic2.src = "themes/TBDev/images/ratio/star.gif";

  pic3 = new Image(25,75);
  pic3.src = "themes/TBDev/images/ratio/star.gif";

  pic4 = new Image(16,13);
  pic4.src = "themes/TBDev/images/ratio/tick.gif";

  pic5 = new Image(14,14);
  pic5.src = "themes/TBDev/images/ratio/warning.gif";
}
...
function rate(rating,id,show5,showPerc,showVotes){
	...
	var uldiv = document.getElementById('ul_'+id);
		...
		if (xmlHttp.readyState == 4){
			...
			loader.innerHTML = '<img src="pic/loading.gif" alt="loading" />';
		}
