...
while($tpl = mysql_fetch_array($sql))
{
    ?><tr><td width="30%" align="right" style="padding: 2px;">
		<?=$tpl['name'];?></td><td style="padding: 2px;">[<a href="tpls.php?act=edit&tpl=<?=$tpl['id'];?>">Редактировать</a>] [<a href="tpls.php?act=del&tpl=<?=$tpl['id'];?>">Удалить</a>]</td></tr><?php
}
?> </table> <?php
end_frame();

begin_frame('Управление');
?> <a href="tpls.php?act=add">Добавить</a> <?php
end_frame();
}
elseif($_GET['act']=='add')
{
