...
name = '$country_name', 
country_id = '$country_id' WHERE id=".sqlesc($id); 
...
$ct_r = mysql_query("SELECT id,name FROM countries") or die; 
...
$ct_r = mysql_query("SELECT id,name,flagpic FROM countries WHERE id=$country_id ") or die; 
while ($ct_a = mysql_fetch_array($ct_r)) 
