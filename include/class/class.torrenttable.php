...
?>
<td class="colhead" align="center"><a href="browse.php?<?php print $oldlink; ?>sort=2&type=<?php print $link2; ?>" class="altlink_white"><img src="pic/torrenttable/files.gif" border="0" alt="Файлов"></a></td>
<td class="colhead" align="center"><a href="browse.php?<?php print $oldlink; ?>sort=3&type=<?php print $link3; ?>" class="altlink_white"><img src="pic/torrenttable/comments.gif" border="0" alt="Комментариев"></a></td>
<?php if ($use_ttl) {
?>
...
?>
<td class="colhead" align="center"><a href="browse.php?<?php print $oldlink; ?>sort=5&type=<?php print $link5; ?>" class="altlink_white"><img src="pic/torrenttable/mb.gif" border="0" alt="Размер"></a></td>
<td class="colhead" align="center"><a href="browse.php?<?php print $oldlink; ?>sort=7&type=<?php print $link7; ?>" class="altlink_white"><img src="pic/torrenttable/seeders.gif" border="0" alt="Сидеров"></a></td>
<td class="colhead" align="center"><a href="browse.php?<?php print $oldlink; ?>sort=8&type=<?php print $link8; ?>" class="altlink_white"><img src="pic/torrenttable/leechers.gif" border="0" alt="Личеров"></a></td>
<?php
