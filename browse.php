...
if ((int)$_GET['sort'] && (int)$_GET['type']) {
    ...
    switch ($_GET['sort']) {
        ...
        case '9':
            ...
            break;
        case '10':
            if (get_user_class() >= UC_MODERATOR) $column = "moderatedby";
            break;
        default:
            $column = "id";
            break;
...
<table class="bottom" width="100%">
    <form method="get" action="browse.php">
        <tr>
            <td style="border: none;"><b>Поиск по названию:</b></td>
    ...
    <div class="module">
        <div class="mone">
            <div class="mtwo">
                <div class="mthree">
                    <h3>
                        <div style="float:left;">Обзор торрентов</div>
                        <div style="margin-top: 13px; display:none; float:right;" id="loading-layer"><img src="pic/upload.gif" border="0" alt="Загрузка"></div>
                    </h3>
                    <div class="mfour">
                        <table class="embedded" cellspacing="0" cellpadding="2" width="100%">
